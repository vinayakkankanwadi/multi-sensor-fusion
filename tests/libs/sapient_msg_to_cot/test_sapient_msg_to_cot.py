"""Converter unit tests — exercise each content type with a known input.

Runs inside the regression image (see tests/Dockerfile), which installs
the `sapient_msg_to_cot` package and the SAPIENT v2 proto bindings on
PYTHONPATH. No service-side dependency.
"""
...
import sapient_msg_to_cot as cvt
